...
export class InitDb1595246027515 implements MigrationInterface {
    name = 'InitDb1595246027515'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `formula` (`id` int NOT NULL AUTO_INCREMENT, `createdAt` datetime NOT NULL, `updatedAt` datetime NOT NULL, `density` int NOT NULL, `version` int NOT NULL, `detergentId` int NULL, `ratioId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
